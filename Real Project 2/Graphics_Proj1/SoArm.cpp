...
void SoArm::init(float x, float y, float z, string imagePath)
{
...
void SoArm::calculateParameters() {
...
void SoArm::build(float r, float l, int _nfaces)
{
	T.clear();
