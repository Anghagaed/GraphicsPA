...
void SoJoint::init(float x, float y, float z, string imagePath)
{
...
void SoJoint::calculateParameters() {
...
void SoJoint::build(float r, float l, int _nfaces)
{
	T.clear();
