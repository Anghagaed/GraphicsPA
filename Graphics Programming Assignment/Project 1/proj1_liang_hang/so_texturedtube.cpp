...
void SoTexturedTube::init(float x, float y, float z, string imagePath)
{
...
void SoTexturedTube::build(float r, float l, int _nfaces)
{
	T.clear();
...
void SoTexturedTube::draw(const GsMat& tr, const GsMat& pr, const GsLight& l)
{
	float f[4];
