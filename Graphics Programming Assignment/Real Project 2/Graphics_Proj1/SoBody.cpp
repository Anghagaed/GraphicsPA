...
void SoBody::updateTexture(bool which)
{
	if (!which) // Texture # 1
	{
...
// Draws Tube
void SoBody::drawTube(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l)
{
	// Get a,b,c,d
	// Get top coordinates
...
// Draws Circle
void SoBody::drawCircle(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l) //, int frame_num, double circle_rate, double radius, double curr_angle_r, double curr_angle_l)
{
	// Get top coordinates
	double radius = radiusTop;
	// side of the rectangles in the tube setion
...
void SoBody::drawCapsule(int nfaces, double radiusTop, double radiusBot)
{
	// Variables
...
void SoBody::build(int nfaces, double radiusTop, double radiusBot)
{
...
void SoBody::draw(const GsMat& tr, const GsMat& pr, const GsLight& l, const float& fs)
{
	if (fs < 0)
	{
