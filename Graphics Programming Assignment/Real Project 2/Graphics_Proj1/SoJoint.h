...
#ifndef SO_TEXTURED_JOINT
#define SO_TEXTURED_JOINT
...
private:
	...
	void SoJoint::drawCircle(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l);
public:
