...
#ifndef SO_TEXTURED_HEAD
#define SO_TEXTURED_HEAD
...
private:
	...
	void SoHead::drawCircle(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l);
public:
