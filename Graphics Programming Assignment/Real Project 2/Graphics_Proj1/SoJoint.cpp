...
// Draws Tube
void SoJoint::drawTube(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l)
{
	// Get a,b,c,d
	// Get top coordinates
...
// Draws Circle
void SoJoint::drawCircle(double radiusTop, double radiusBot, double height, double sine_r, double cosine_r, double sine_l, double cosine_l) //, int frame_num, double circle_rate, double radius, double curr_angle_r, double curr_angle_l)
{
	// Get top coordinates
	double radius = radiusTop;
	// side of the rectangles in the tube setion
...
void SoJoint::drawCapsule(int nfaces, double radiusTop, double radiusBot)
{
	// Variables
...
void SoJoint::build(int nfaces, double radiusTop, double radiusBot)
{
