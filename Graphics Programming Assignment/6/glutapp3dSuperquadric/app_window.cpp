...
void AppWindow::glutKeyboard ( unsigned char key, int x, int y )
 {
	...
	*/
	...
	case 'z': _texturedtube.flat(true); redraw(); break;
	case 'x': _texturedtube.flat(false); redraw(); break;
	case 'c': _normals = true; redraw(); break;
	case 'v': _normals = false; redraw(); break;
	case 'w': r1 += 0.05; redraw(); break;
	case 's': r1 -= 0.05; redraw(); break;
	case 'e': r2 += 0.05; redraw(); break;
	case 'd': r2 -= 0.05; redraw(); break;
	}
 }
...
void AppWindow::glutDisplay ()
 {
   ...
   _texturedtube.build(r1, r2, 0.70, _numfaces);
   ...
   _texturedtube.draw(stransf, sproj, _light, _x);
